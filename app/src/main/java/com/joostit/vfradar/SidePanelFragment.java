 ...
 * {@link SidePanelFragment.OnSidePanelInteractionListener} interface
...
public class SidePanelFragment extends Fragment implements AircraftListFragment.OnAircraftListInteractionListener {
    ...
    private OnSidePanelInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSidePanelInteractionListener) {
            mListener = (OnSidePanelInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnSidePanelInteractionListener");
        }
    }
     ...
     */
    public interface OnSidePanelInteractionListener {
